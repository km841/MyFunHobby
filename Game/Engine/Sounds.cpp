...
bool Sounds::CreateSound(const std::string& path, FMOD::Sound** sound)
{
...
void Sounds::SoundPlay(FMOD::Sound* sound, FMOD::Channel** channel)
{
	mCoreSystem->playSound(sound, 0, false, channel);
}

void Sounds::Set3DListenerAttributes(const Vec3* pos, const Vec3* vel, const Vec3* forward, const Vec3* up)
{
