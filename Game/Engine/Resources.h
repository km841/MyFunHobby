...
public:
	...
	shared_ptr<Texture> CreateTexture(const wstring& szName, TEXTURE_TYPE eType, uint32 iWidth, uint32 iHeight);
	shared_ptr<Texture> CreateTextureFromResource(const wstring& szName, TEXTURE_TYPE eType, ComPtr<ID3D11Texture2D> iTexture);
