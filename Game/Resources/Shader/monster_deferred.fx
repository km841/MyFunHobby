...
PS_OUT PS_Main(VS_OUT _in)
{
    ...
    float fHitColor = float4(1.f, 1.f, 1.f, 0.f) * fHitRatio;
   
    output.vPosition = float4(_in.viewPos, 0.f);
    output.vColor = vColor + fHitColor;
